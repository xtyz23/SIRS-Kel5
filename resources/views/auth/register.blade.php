@extends('layouts.app', [
    'class' => 'register-page',
    'backgroundImagePath' => 'img/bg/bgg.jpg'
])
                        ...
                        <div class="card-body ">
                            <form class="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="input-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="Nama" value="{{ old('name') }}" required autofocus>
                                    @if ($errors->has('name'))
                                ...
                                <div class="card-footer ">
                                    <button type="submit" class="btn btn-info btn-round">{{ __('Registrasi') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
